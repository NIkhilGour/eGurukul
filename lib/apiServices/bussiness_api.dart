...
class BussinessApi
{
    ...
    final url = Uri.parse(
        'https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=468bc846dea74c1da514e2e40de6b7ef');
...
final bussinessnewsprovider = Provider<BussinessApi>((ref) => BussinessApi());