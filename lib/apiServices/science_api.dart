...
class ScienceApi
{
    ...
    final url = Uri.parse(
        'https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=468bc846dea74c1da514e2e40de6b7ef');
...
final sciencenewsprovider = Provider<ScienceApi>((ref) => ScienceApi());