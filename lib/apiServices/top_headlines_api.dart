...
class TopheadlinesApi {
  Future<List<News>> fetchdata() async {
    final url = Uri.parse(
        'https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=468bc846dea74c1da514e2e40de6b7ef');
...
final topheadlinesnewsProvider = Provider<TopheadlinesApi>((ref) => TopheadlinesApi());
